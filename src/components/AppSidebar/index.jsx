    ...
    return (
      ...
      <div className='App__sidebar'>
        ...
        <div className='SearchCategories'>
          <button className='SearchCategories__btn'>popular</button>
          <button className='SearchCategories__btn'>top rated</button>
          <button className='SearchCategories__btn'>upcoming</button>
        </div>
